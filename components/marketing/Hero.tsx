    ...
    <section className="relative overflow-hidden pt-12 pb-20 lg:pt-24 lg:pb-32">
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 relative z-10">
            ...
            >
              <div className="flex items-center gap-2">
                <span className="font-mono tabular-nums text-graphite-50 font-semibold">{STATS[0].value}</span>
                <span>лет опыта</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-mono tabular-nums text-graphite-50 font-semibold">{STATS[1].value}</span>
                <span>филиала</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-mono tabular-nums text-graphite-50 font-semibold">{STATS[2].value}</span>
                <span>постов</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          {/* Right: car silhouette / hero visual */}
          <div className="lg:col-span-5 relative">
            ...
            >
              {/* SVG car silhouette (BMW-like sport sedan) */}
              <svg
                viewBox="0 0 600 480"
