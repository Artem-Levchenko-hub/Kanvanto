...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // Apple-style: SF Pro подобный Inter для display и body
        display: ['"SF Pro Display"', "var(--font-display)", "ui-sans-serif", "system-ui", "sans-serif"],
        sans: ['"SF Pro Text"', "var(--font-sans)", "ui-sans-serif", "system-ui", "sans-serif"],
        mono: ["var(--font-jetbrains)", "ui-monospace", "SFMono-Regular", "monospace"],
      },
      fontSize: {
        // Apple-style: огромные display + thin weights + tight tracking
        "display-2xl": ["clamp(4rem, 8vw + 1rem, 8.5rem)", { lineHeight: "0.9", letterSpacing: "-0.045em", fontWeight: "300" }],
        "display-xl": ["clamp(3.25rem, 6vw + 1rem, 7rem)", { lineHeight: "0.95", letterSpacing: "-0.04em", fontWeight: "300" }],
        "h1": ["clamp(2.5rem, 3.5vw + 1rem, 4.75rem)", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "400" }],
        "h2": ["clamp(2rem, 2.5vw + 0.5rem, 3.5rem)", { lineHeight: "1.1", letterSpacing: "-0.025em", fontWeight: "400" }],
        "h3": ["clamp(1.5rem, 1.5vw + 0.5rem, 2.25rem)", { lineHeight: "1.2", letterSpacing: "-0.02em", fontWeight: "500" }],
        "h4": ["clamp(1.25rem, 1vw + 0.5rem, 1.625rem)", { lineHeight: "1.3", letterSpacing: "-0.015em", fontWeight: "500" }],
        "h5": ["1.25rem", { lineHeight: "1.4", letterSpacing: "-0.01em", fontWeight: "500" }],
        "h6": ["1.125rem", { lineHeight: "1.45", letterSpacing: "-0.005em", fontWeight: "500" }],
        "body-xl": ["clamp(1.25rem, 1vw + 0.75rem, 1.5rem)", { lineHeight: "1.5", letterSpacing: "-0.01em", fontWeight: "400" }],
